...
if len(sys.argv) < 5:
    print("Usage for AF2:")
    print(
        "   python ipsae.py <path_to_pae_json_file> <path_to_pdb_file> <pae_cutoff> <dist_cutoff>"
    )
    print(
    ...
    print("Usage for AF3:")
    print(
        "   python ipsae.py <path_to_pae_json_file> <path_to_mmcif_file> <pae_cutoff> <dist_cutoff>"
    )
    print(
    ...
    for line in PDB:
        ...
        if line.startswith("ATOM") or line.startswith("HETATM"):
            ...
            if (
                ...
                or (atom["residue_name"] == "UNK" and atom["atom_name"] == "CA")
            ):
                cb_residues.append(
                    {
                        "atom_num": atom["atom_num"],
...
for pair in sorted(chainpairs):
    ...
    for pair in (pair1, pair2):
        ...
        outstring = (
            f'{chain1}    {chain2}     {pae_string:3}  {dist_string:3}  {"asym":5} '
            + (
        ...
        if chain1 > chain2:
            ...
            outstring = (
                f'{chain2}    {chain1}     {pae_string:3}  {dist_string:3}  {"max":5} '
                + (
        ...
        PML.write(
            f"alias {chain_pair}, color {color1}, {chain1_residues}; color {color2}, {chain2_residues}\n\n"
        )
    OUT.write("\n")
